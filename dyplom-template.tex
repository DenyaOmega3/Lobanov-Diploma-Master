...
Якщо $\Lambda = \left<1,\omega_1,\omega\right>$, то елемент $\theta$ можна подати в такому вигляді:
\begin{align*}
\theta = \dfrac{\beta \omega_1 + \gamma \omega_2 + \alpha}{p},
\end{align*}
де числа $\alpha,\beta,\gamma,p \in \mathbb{Z}$. Для того, щоб $\tilde{\Lambda}$ стало кільцем, досить вимагати, щоб $\theta^3 \in \left<1,\omega,\omega^2\right>$.
...
\begin{align*}
\det [\theta],\ M_{2 \times 2}p\theta],\ \tr [\theta] \in \mathbb{Z}.
\end{align*}
